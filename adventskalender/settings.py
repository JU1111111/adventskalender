...
CSRF_TRUSTED_ORIGINS = ['https://13g-advent.de','https://www.13g-advent.de']
...
AUTHENTICATION_BACKENDS = ['adventskalender.customAuth.EmailBackend']
...
emailData = emailTesters.getDataFromTheJson()
...
EMAIL_HOST_PASSWORD = emailData['EMAIL_HOST_PASSWORD']
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
